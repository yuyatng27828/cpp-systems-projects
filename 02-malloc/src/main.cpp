...
int main()
{
    ...
    int *a = static_cast<int *>(naive_malloc(sizeof(int)));
    *a = 10;
    std::cout << "Allocating Block A:" << "\n";
    std::cout << "Value=" << *a << "\n";
    std::cout << "Address=" << a << "\n";
    int *b = static_cast<int *>(naive_malloc(sizeof(int)));
    *b = 20;
    std::cout << "Allocating Block B:" << "\n";
    std::cout << "Value=" << *b << "\n";
    std::cout << "Address=" << b << "\n";
    int *c = static_cast<int *>(naive_malloc(sizeof(int)));
    *c = 30;
    std::cout << "Allocating Block C:" << "\n";
    std::cout << "Value=" << *c << "\n";
    std::cout << "Address=" << c << "\n";
    int *d = static_cast<int *>(naive_malloc(sizeof(int)));
    *d = 40;
    ...
    naive_free(b);
    std::cout << "Freeing Block D...\n";
    naive_free(d);

    int *e = static_cast<int *>(naive_malloc(sizeof(int)));
    *e = 50;
    std::cout << "Allocating Block E:" << "\n";
    std::cout << "Value=" << *e << "\n";
    std::cout << "Address=" << e << "\n";
    // int *f = static_cast<int *>(naive_malloc(sizeof(int)));
    // *f = 60;
